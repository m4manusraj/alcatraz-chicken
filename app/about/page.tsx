    ...
    <Layout>
      ...
      <section className="py-12 sm:py-16 bg-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container px-4 relative">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            >
              <Badge variant="secondary" className="bg-orange-500/10 text-orange-500 mb-4">Our Beginning</Badge>
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
                Breaking Free From
                <span className="text-orange-500 block mt-2">Ordinary Flavor</span>
              </h2>
              <p className="text-gray-400 text-base sm:text-lg mb-6">
                Alcatraz Chicken was born from a passion for creating extraordinary flavors 
                and pushing the boundaries of what fried chicken can be. Our dedication to 
                perfection led to the development of our signature recipes that would make 
                every meal exceptional.
              </p>
              <p className="text-gray-400 text-base sm:text-lg">
                Today, we bring that same dedication to every piece of chicken we serve, 
                using our signature 13-spice blend and 24-hour marination process to ensure 
                each bite is a taste of freedom.
              </p>
            </motion.div>
      ...
      <section className="py-12 sm:py-16 bg-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container px-4 relative">
          ...
          >
            <Badge variant="secondary" className="bg-orange-500/10 text-orange-500 mb-4">Our Values</Badge>
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
              What Sets Us
            ...
            {[
              {
                ...
                description: "We use only the freshest ingredients and premium chicken, prepared daily with our signature recipes.",
                delay: 0
              },
              {
              ...
              },
              {
                ...
                description: "We're proud to be part of the Kelowna community and strive to give back whenever possible.",
                delay: 0.2
              },
              {
              ...
              },
              {
                ...
                description: "Your satisfaction is our top priority. We guarantee every meal will meet our high standards.",
                delay: 0.4
              },
              {
                title: "Team Excellence",
                description: "Our team is trained to provide exceptional service and maintain the highest quality standards.",
                delay: 0.5
              }
            ].map((value, index) => (
              <motion.div
